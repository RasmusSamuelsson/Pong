...
public class GamePanel extends JPanel implements Runnable{
    ...
    public void newPaddles(){
        paddle1 = new Paddle(0,(GAME_HEIGHT/2)-(PADDLE_HEIGHT/2),PADDLE_WITH,PADDLE_HEIGHT,1);
        paddle2 = new Paddle(GAME_WIDTH-PADDLE_WITH,(GAME_HEIGHT/2)-(PADDLE_HEIGHT/2),PADDLE_WITH,PADDLE_HEIGHT,2);
    ...
    public void checkCollision (){
        ...
        if (ball.intersects(paddle1)) {
            ...
            if (ball.yVelocity>0)
                ball.yVelocity++; //Also optional for speed
            else
                ball.yVelocity--;
